...
interfaces {
    ethernet eth0 {
        address 10.0.17.14/24
        description WAN
        hw-id 00:50:56:b3:ca:64
    }
    ethernet eth1 {
        address 10.0.5.2/24
        description LAN
        hw-id 00:50:56:b3:80:02
    }
    ethernet eth2 {
        address 10.0.6.2/24
        description OPT
        hw-id 00:50:56:b3:40:a9
    }
    loopback lo {
    }
}
nat {
    destination {
        rule 1 {
            description "Port Forwarding from WAN -> Web-01(HTTP)"
            destination {
                port 80
            }
